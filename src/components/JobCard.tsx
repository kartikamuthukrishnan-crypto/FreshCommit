...
export const JobCard: React.FC<JobCardProps> = ({ job, onSelect }) => {
  ...
  return (
    <div
      id={`job-card-${job.id}`}
      className="group relative bg-white rounded-xl border border-slate-200/90 hover:border-indigo-400/80 hover:shadow-md transition-all p-5 flex flex-col justify-between"
    >
      <div>
